...
public class CraftingRegister extends TSCrafting {
	...
	public static void registerRecipes()
	{
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BlockList.runeReader, 1), new Object[] {"BDB", "RQR", "BCB", 'B' , "stone", 'D', "blockDiamond", 'R', ItemList.craftingRune, 'Q', "blockQuartz", 'C', "blockRedstone"}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BlockList.advancedRuneReader, 1), new Object[] {"EGE", "QRQ", "QOQ", 'E' , "blockEmerald", 'G', "blockGold", 'R', BlockList.runeReader, 'Q', "blockQuartz", 'O', "obsidian"}));
