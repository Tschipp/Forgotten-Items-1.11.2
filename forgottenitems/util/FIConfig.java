...
public class FIConfig {
	...
	public static void syncConfig()
	{
		try {
			...
			customBoundColors = FIM.config.getStringList("customBoundColors", "misc", new String[]{"Tschipp", "16761856", "Janunalai", "65280", "Nerval_", "12517631", "HarryH17", "11337728"}, "Add new custom bound tool colors for your player. First, type the name of the player, then the color (A hex color converted to decimal)");
			...
			//BLOCKS
			runeReaderEmitsParticles = FIM.config.getBoolean("runeReaderEmitsParticles", "blocks", true, "Wether the Rune Reader should emit particles");
